...
const imageUrl = computed(() => {
  return proxy.globalInfo.imageUrl + fileInfo.value.fileCover.replace(/_\.([^_.]*)$/, ".$1") // replace the last "_." to "."
})
...
<template>
  ...
  <Window
      :show="windowShow"
      @close="closeWindow"
      :width="fileInfo.fileCategory == 1 ? 2000 : 1200"
      :title="fileInfo.fileName"
      :align="fileInfo.fileCategory == 1 ? 'center': 'top'"
      v-if="fileInfo.fileCategory != 3  && fileInfo.folderType == 0">
